        ...
        protected function printAxis() {
            ...
            for ($i = 0; $i <= $pointCount; $i++) {
                ...
                if ($i < $pointCount) {
                    ...
                    $text->printText($img, $graphArea->x1 - 10, $y - $rowHeight / 2, $this->plot->getTextColor(), $label, $text->fontCondensed, $text->HORIZONTAL_RIGHT_ALIGN | $text->VERTICAL_CENTER_ALIGN);
                }
            }
        }
